...
namespace IIS.Proba1
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba1.ЕдИзм fЕдИзм;
        ...
        public virtual IIS.Proba1.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Proba1.ЕдИзм result = this.fЕдИзм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Proba1.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Proba1.Товары));
                }
            }
        }
    }
