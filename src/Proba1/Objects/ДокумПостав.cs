...
namespace IIS.Proba1
{
    ...
    [View("ДокумПоставE", new string[] {
            ...
            "Организация.НаимОрганиз as \'Наим организ\'",
            "Клиенты as \'Клиенты\'",
            "Клиенты.НаимЗаказа as \'Наим заказа\'",
            "Клиенты.АдресПоставщика as \'Адрес Поставки\'",
            "Клиенты.Телефон as \'Телефон\'"}, Hidden=new string[] {
            "Организация.НаимОрганиз",
            "Клиенты.НаимЗаказа"})]
    [AssociatedDetailViewAttribute("ДокумПоставE", "ТЧИнфОЗаказе", "ТЧИнфОЗакE", true, "", "Т ч инф о заказе", true, new string[] {
            ""})]
    [MasterViewDefineAttribute("ДокумПоставE", "Организация", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НаимОрганиз")]
    [MasterViewDefineAttribute("ДокумПоставE", "Клиенты", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НаимЗаказа")]
    ...
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba1.DetailArrayOfТЧИнфОЗак fТЧИнфОЗаказе;
        ...
        /// Докум постав.
        /// </summary>
        // *** Start programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе CustomAttributes)

        // *** End programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе CustomAttributes)
        public virtual IIS.Proba1.DetailArrayOfТЧИнфОЗак ТЧИнфОЗаказе
        {
            get
            {
                // *** Start programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Get start)

                // *** End programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Get start)
                if ((this.fТЧИнфОЗаказе == null))
                {
                    this.fТЧИнфОЗаказе = new IIS.Proba1.DetailArrayOfТЧИнфОЗак(this);
                }
                IIS.Proba1.DetailArrayOfТЧИнфОЗак result = this.fТЧИнфОЗаказе;
                // *** Start programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Get end)

                // *** End programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Set start)

                // *** End programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Set start)
                this.fТЧИнфОЗаказе = value;
                // *** Start programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Set end)

                // *** End programmer edit section *** (ДокумПостав.ТЧИнфОЗаказе Set end)
            }
        }
