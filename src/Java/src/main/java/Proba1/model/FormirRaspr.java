 ...
 */
@Entity(name = "IISProba1ФормирРаспр")
...
public class FormirRaspr {
    ...
    @Column(name = "НомерДогРаспр")
    private Integer номердограспр;
    ...
    public Integer getНомерДогРаспр() {
      return номердограспр;
    }

    public void setНомерДогРаспр(Integer номердограспр) {
      this.номердограспр = номердограспр;
    }
